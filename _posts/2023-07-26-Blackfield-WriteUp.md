...
tags: [asreproasting, active directory, bloodhound, lsass, sebackupprivilege, forcechangepassword, pypykatz, ntds, nmap, crackmapexec, smbmap, guest session, kerbrute, getnpusers.py, john, evil-winrm, rpc, bloodhound-python, montura smb, backup operators, diskshadow, secretsdump.py, efs, cipher, sam]     # TAG names should always be lowercase
